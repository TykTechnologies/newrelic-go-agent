...
// (https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/_integrations) directory --
...
// (https://godoc.org/github.com/TykTechnologies/newrelic-go-agent#Transaction) API.  In this
