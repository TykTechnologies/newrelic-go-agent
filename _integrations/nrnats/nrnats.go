...
// (https://godoc.org/github.com/TykTechnologies/newrelic-go-agent#MessageProducerSegment) for NATS
// publishers.  Call this function before calling any method that publishes or
// responds to a NATS message.  Call `End()`
// (https://godoc.org/github.com/TykTechnologies/newrelic-go-agent#MessageProducerSegment.End) on the
