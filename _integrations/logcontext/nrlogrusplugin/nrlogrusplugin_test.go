...
import (
	...
	"github.com/TykTechnologies/newrelic-go-agent/internal/sysinfo"
...
func TestLogNoContext(t *testing.T) {
	...
	validateOutput(t, out, map[string]interface{}{
		...
		"log.level":   "info",
		"message":     "Hello World!",
		"method.name": "github.com/TykTechnologies/newrelic-go-agent/_integrations/logcontext/nrlogrusplugin.TestLogNoContext",
...
func TestLogNoTxn(t *testing.T) {
	...
	validateOutput(t, out, map[string]interface{}{
		...
		"log.level":   "info",
		"message":     "Hello World!",
		"method.name": "github.com/TykTechnologies/newrelic-go-agent/_integrations/logcontext/nrlogrusplugin.TestLogNoTxn",
		"timestamp":   float64(1417136460000),
	})
}
...
func TestLogDistributedTracingDisabled(t *testing.T) {
	...
	validateOutput(t, out, map[string]interface{}{
		...
		"log.level":   "info",
		"message":     "Hello World!",
		"method.name": "github.com/TykTechnologies/newrelic-go-agent/_integrations/logcontext/nrlogrusplugin.TestLogDistributedTracingDisabled",
		"timestamp":   float64(1417136460000),
	})
}
...
func TestLogSampledFalse(t *testing.T) {
	...
	validateOutput(t, out, map[string]interface{}{
		...
		"log.level":   "info",
		"message":     "Hello World!",
		"method.name": "github.com/TykTechnologies/newrelic-go-agent/_integrations/logcontext/nrlogrusplugin.TestLogSampledFalse",
		"timestamp":   float64(1417136460000),
...
func TestLogSampledTrue(t *testing.T) {
	...
	validateOutput(t, out, map[string]interface{}{
		...
		"log.level":   "info",
		"message":     "Hello World!",
		"method.name": "github.com/TykTechnologies/newrelic-go-agent/_integrations/logcontext/nrlogrusplugin.TestLogSampledTrue",
...
func TestEntryUsedTwice(t *testing.T) {
	...
	validateOutput(t, out, map[string]interface{}{
		...
		"log.level":   "info",
		"message":     "Hello World!",
		"method.name": "github.com/TykTechnologies/newrelic-go-agent/_integrations/logcontext/nrlogrusplugin.TestEntryUsedTwice",
		"span.id":     "bcfb32e050b264b8",
		"timestamp":   float64(1417136460000),
		"trace.id":    "d9466896a525ccbf",
	})
...
func TestEntryError(t *testing.T) {
	...
	validateOutput(t, out, map[string]interface{}{
		...
		"message":     "Hello World!",
		"method.name": "github.com/TykTechnologies/newrelic-go-agent/_integrations/logcontext/nrlogrusplugin.TestEntryError",
		"timestamp":   float64(1417136460000),
	})
}
...
func TestWithCustomField(t *testing.T) {
	...
	validateOutput(t, out, map[string]interface{}{
		...
		"log.level":   "info",
		"message":     "Hello World!",
		"method.name": "github.com/TykTechnologies/newrelic-go-agent/_integrations/logcontext/nrlogrusplugin.TestWithCustomField",
		"timestamp":   float64(1417136460000),
		"zip":         "zap",
	})
}
