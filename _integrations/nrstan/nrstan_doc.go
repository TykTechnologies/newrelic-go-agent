...
// (https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/_integrations/nrnats/#StartPublishSegment)
...
// https://github.com/TykTechnologies/newrelic-go-agent/blob/master/_integrations/nrstan/examples/main.go
package nrstan
