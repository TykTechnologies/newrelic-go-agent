...
//
// Full server example:
// https://github.com/TykTechnologies/newrelic-go-agent/blob/master/_integrations/nrgrpc/example/server/server.go
//
...
//
// Full client example:
// https://github.com/TykTechnologies/newrelic-go-agent/blob/master/_integrations/nrgrpc/example/client/client.go
package nrgrpc
