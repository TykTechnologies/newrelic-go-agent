...
import (
	...
	internal "github.com/TykTechnologies/newrelic-go-agent/_integrations/nrawssdk/internal"
	agentinternal "github.com/TykTechnologies/newrelic-go-agent/internal"
)
