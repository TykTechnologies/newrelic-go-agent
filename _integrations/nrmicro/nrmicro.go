...
// (https://godoc.org/github.com/TykTechnologies/newrelic-go-agent#NewContext) when calling one
// of those methods.
...
// `newrelic.NewContext`
// (https://godoc.org/github.com/TykTechnologies/newrelic-go-agent#NewContext) when calling
// `Call`.
