...
// (https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/integrations/logcontext/#pkg-constants).
//
...
import (
	...
	"github.com/TykTechnologies/newrelic-go-agent/v3/integrations/logcontext"
