...
//
//	import (
//		_ "github.com/TykTechnologies/newrelic-go-agent/v3/integrations/nrmysql"
//	)
//
//	func main() {
...
// https://github.com/TykTechnologies/newrelic-go-agent/tree/master/v3/integrations/nrmysql/example/main.go
package nrmysql
