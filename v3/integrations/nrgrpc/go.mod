module github.com/TykTechnologies/newrelic-go-agent/v3/integrations/nrgrpc
...
require (
	...
	github.com/TykTechnologies/newrelic-go-agent/v3/integrations/nrsecurityagent v1.1.0
