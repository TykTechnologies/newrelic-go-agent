...
//
// Full server example:
// https://github.com/TykTechnologies/newrelic-go-agent/blob/master/v3/integrations/nrgrpc/example/server/server.go
//
// Client
//
...
//
// Full client example:
// https://github.com/TykTechnologies/newrelic-go-agent/blob/master/v3/integrations/nrgrpc/example/client/client.go
package nrgrpc
