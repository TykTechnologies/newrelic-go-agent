...
import (
	...
	"github.com/TykTechnologies/newrelic-go-agent/v3/integrations/nrgrpc"
	sampleapp "github.com/TykTechnologies/newrelic-go-agent/v3/integrations/nrgrpc/example/sampleapp"
