...
// (https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/integrations) directory --
...
// (https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/newrelic#Transaction.AddAttribute)
