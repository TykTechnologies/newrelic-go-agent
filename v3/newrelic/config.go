...
import (
	...
	"github.com/TykTechnologies/newrelic-go-agent/v3/internal/sysinfo"
...
type Config struct {
	...
	//
	// See https://github.com/TykTechnologies/newrelic-go-agent/blob/master/GUIDE.md#logging
...
type config struct {
	...
	// https://github.com/TykTechnologies/newrelic-go-agent/issues/127
