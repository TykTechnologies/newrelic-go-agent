...
func TestCodeLocation(t *testing.T) {
	...
	if loc1.LineNo != 18 || loc1.Function != "github.com/TykTechnologies/newrelic-go-agent/v3/newrelic.TestCodeLocation" || !strings.HasSuffix(loc1.FilePath, "/go-agent/v3/newrelic/code_level_metrics_test.go") {
	...
	if loc2.LineNo != 13 || loc2.Function != "github.com/TykTechnologies/newrelic-go-agent/v3/newrelic.anotherFunction" || !strings.HasSuffix(loc2.FilePath, "/go-agent/v3/newrelic/code_level_metrics_test.go") {
...
func TestClosureCLM(t *testing.T) {
	...
	if l.LineNo != 40 || l.Function != "github.com/TykTechnologies/newrelic-go-agent/v3/newrelic.TestClosureCLM.func1" || !strings.HasSuffix(l.FilePath, "/go-agent/v3/newrelic/code_level_metrics_test.go") {
...
func TestBasicCaching(t *testing.T) {
	...
	if l.LineNo != 13 || l.Function != "github.com/TykTechnologies/newrelic-go-agent/v3/newrelic.anotherFunction" || !strings.HasSuffix(l.FilePath, "/go-agent/v3/newrelic/code_level_metrics_test.go") {
		t.Errorf("FunctionLocation() returned %v", l)
	}

	if c.location == nil {
		t.Errorf("FunctionLocation cache location is nil")
	} else if c.location.LineNo != 13 || c.location.Function != "github.com/TykTechnologies/newrelic-go-agent/v3/newrelic.anotherFunction" || !strings.HasSuffix(c.location.FilePath, "/go-agent/v3/newrelic/code_level_metrics_test.go") {
...
func TestCachedCodeLocation(t *testing.T) {
	...
	if loc1.LineNo != 78 || loc1.Function != "github.com/TykTechnologies/newrelic-go-agent/v3/newrelic.TestCachedCodeLocation" || !strings.HasSuffix(loc1.FilePath, "/go-agent/v3/newrelic/code_level_metrics_test.go") {
		t.Errorf("CodeLocation() returned %v", loc1)
	}
	...
	if loc2.LineNo != 78 || loc2.Function != "github.com/TykTechnologies/newrelic-go-agent/v3/newrelic.TestCachedCodeLocation" || !strings.HasSuffix(loc2.FilePath, "/go-agent/v3/newrelic/code_level_metrics_test.go") {
		t.Errorf("FunctionLocation() returned %v", loc2)
	}
...
func TestTraceOptions(t *testing.T) {
	...
	if o.LocationOverride == nil {
		...
		if o.LocationOverride.LineNo != 110 || o.LocationOverride.Function != "github.com/TykTechnologies/newrelic-go-agent/v3/newrelic.TestTraceOptions" || !strings.HasSuffix(o.LocationOverride.FilePath, "/go-agent/v3/newrelic/code_level_metrics_test.go") {
...
func TestTraceOptions2(t *testing.T) {
	...
	if o.LocationOverride == nil {
		...
		if o.LocationOverride.LineNo != 13 || o.LocationOverride.Function != "github.com/TykTechnologies/newrelic-go-agent/v3/newrelic.anotherFunction" || !strings.HasSuffix(o.LocationOverride.FilePath, "/go-agent/v3/newrelic/code_level_metrics_test.go") {
			t.Errorf("function location set to %v", *o.LocationOverride)
		}
	}
