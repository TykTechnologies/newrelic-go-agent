...
import (
	...
	"github.com/TykTechnologies/newrelic-go-agent/internal/stacktracetest"
)
...
func TestStacktraceFrames(t *testing.T) {
	...
	inputFrames := []stacktraceFrame{
		{
			File: "/Users/will/Desktop/gopath/src/github.com/TykTechnologies/newrelic-go-agent/internal/stacktrace.go",
			Name: "github.com/TykTechnologies/newrelic-go-agent/internal.GetStackTrace",
			Line: 17,
		},
		{
			File: "/Users/will/Desktop/gopath/src/github.com/TykTechnologies/newrelic-go-agent/internal_txn.go",
			Name: "github.com/TykTechnologies/newrelic-go-agent.(*txn).NoticeError",
			Line: 696,
		},
		{
			File: "\u003cautogenerated\u003e",
			Name: "go.(*struct { github.com/TykTechnologies/newrelic-go-agent.threadWithExtras }).NoticeError",
			Line: 1,
		},
		{
			File: "/Users/will/Desktop/gopath/src/github.com/TykTechnologies/newrelic-go-agent/internal_attributes_test.go",
			Name: "github.com/TykTechnologies/newrelic-go-agent.TestAddAttributeSecurityPolicyDisablesInclude",
			Line: 68,
		},
		{
