...
func (f stacktraceFrame) isAgent() bool {
	...
	// "go.(*struct { github.com/TykTechnologies/newrelic-go-agent.threadWithExtras }).NoticeError"
	return strings.Contains(f.Name, "github.com/TykTechnologies/newrelic-go-agent/internal.") ||
		strings.Contains(f.Name, "github.com/TykTechnologies/newrelic-go-agent.")
}
