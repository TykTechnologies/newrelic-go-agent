...
(Also see [GETTING_STARTED](https://github.com/TykTechnologies/newrelic-go-agent/blob/master/GETTING_STARTED.md) if you are using the Go agent for the first time).
...
```
go get github.com/TykTechnologies/newrelic-go-agent/v3/newrelic
```
...
* Import any of our [integration packages](https://github.com/TykTechnologies/newrelic-go-agent#integrations) for out-of-the box support for many popular Go web 
...
* [Config godoc](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/newrelic#Config)
* [Application godoc](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/newrelic#Application)
...
[ConfigInfoLogger](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/newrelic/#ConfigInfoLogger),
which logs at info level, and
[ConfigDebugLogger](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/newrelic/#ConfigDebugLogger)
...
* [v3/integrations/nrlogrus](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/integrations/nrlogrus/)
* [v3/integrations/nrlogxi](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/integrations/nrlogxi/)
* [v3/integrations/nrzap](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/integrations/nrzap/)

## Transactions

* [Transaction godoc](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/newrelic#Transaction)
...
[SetWebRequestHTTP](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/newrelic/#Transaction.SetWebRequestHTTP)
...
If you want to mark a transaction as a web transaction, but don't have access
 to an `http.Request`, you can use the [SetWebRequest](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/newrelic/#Transaction.SetWebRequest)
method, using a manually constructed [WebRequest](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/newrelic/#WebRequest)
object.

[SetWebResponse](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/newrelic/#Transaction.SetWebResponse)
...
See more in [godocs](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/newrelic#Transaction).
...
s := newrelic.DatastoreSegment{
    ...
    // https://github.com/TykTechnologies/newrelic-go-agent/blob/master/v3/newrelic/datastore.go.  Product
...
* [v3/integrations/nrpq](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/integrations/nrpq)
* [v3/integrations/nrmysql](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/integrations/nrmysql)
* [v3/integrations/nrsqlite3](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/integrations/nrsqlite3)
* [v3/integrations/nrmongo](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/integrations/nrmongo)
...
* [newrelic package constants](https://godoc.org/github.com/TykTechnologies/newrelic-go-agent/v3/newrelic#pkg-constants)
